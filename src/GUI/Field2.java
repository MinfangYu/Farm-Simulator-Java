...
// TODO: To create the field2 frame
/**
 * The Class Field2.
 */
public class Field2 extends JFrame {
	...
	public Field2() {
		...
		lblPotato.setFont(new Font("Potato", Font.PLAIN, 30));
		lblPotato.setBounds(37, 24, 135, 50);
		...
		label2.setText(Store.field2[2] +"");
		label2.setFont(new Font("Calibri", Font.PLAIN, 26));
		label2.setBounds(250, 234, 97, 42);
		contentPane.add(label2);
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon(Field6.class.getResource("/image/potato.png")));
