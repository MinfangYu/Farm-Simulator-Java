...
// TODO: To create the field4 frame
/**
 * The Class Field4.
 */
public class Field4 extends JFrame {
	...
	public Field4() {
		...
		lblCorn.setFont(new Font("Corn", Font.PLAIN, 30));
		lblCorn.setBounds(37, 24, 135, 50);
		...
		label3.setText(Store.field4[3] +"");
		label3.setFont(new Font("Calibri", Font.PLAIN, 26));
		label3.setBounds(250, 295, 97, 42);
		contentPane.add(label3);
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon(Field6.class.getResource("/image/corn.png")));
